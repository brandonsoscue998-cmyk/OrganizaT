...
export const t = {
  ...
  auth: {
    ...
    roleOwner: "Tengo un espacio",
  },

  clientView: {
    title: "Reservar sesión",
    subtitle: "Busca a tu entrenador y elige un horario",
    trainerLabel: "Entrenador o espacio",
    trainerPlaceholder: "buscar por nombre...",
    findButton: "Buscar",
    notFound: "No se encontró ningún entrenador o espacio con ese usuario.",
  ...
  calendar: {
    ...
    recurringLabel: "Repetir cada semana",
    recurringBadge: "Semanal",
    recurringCreated: "Disponibilidad semanal creada (26 semanas)",
    recurringDeleted: "Horarios recurrentes eliminados",
    deleteRecurringConfirm: "¿Eliminar todos los horarios semanales de este tipo? Esta acción no se puede deshacer.",
