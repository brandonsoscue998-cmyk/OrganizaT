    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-50 to-white p-6">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-[11px] text-muted-foreground/50 mt-8">Powered by <span className="font-semibold">Practitioner</span></p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <p className="text-center text-[11px] text-muted-foreground/50 mt-12">
          Powered by <span className="font-semibold">Practitioner</span>
        </p>
      </div>
    </div>
  );
